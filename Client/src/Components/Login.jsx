    ...
    <div className="flex items-center justify-center min-h-[70vh]">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-tr from-blue-500 to-indigo-600 shadow-lg mb-4 transform hover:scale-110 transition-transform duration-300">
             <FaSignInAlt className="text-white text-2xl" />
          </div>
          <h2 className="text-4xl font-extrabold text-slate-800 tracking-tight">Welcome Back</h2>
          <p className="text-slate-500 mt-2 font-medium">Log in to continue your journey.</p>
        </div>

        <form onSubmit={handleLogin} className="glass-card p-8 rounded-3xl shadow-2xl space-y-6 transform transition-all duration-500 hover:shadow-indigo-500/10">
